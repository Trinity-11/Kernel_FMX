...
GABE_RST_AUTH1      = $AFE823 ; Must Contain the BYTE $DE for Reset to Activate

; READ
GABE_RNG_DAT_LO     = $AFE824 ; Low Part of 16Bit RNG Generator
GABE_RNG_DAT_HI     = $AFE825 ; Hi Part of 16Bit RNG Generator
; WRITE
GABE_RNG_SEED_LO    = $AFE824 ; Low Part of 16Bit RNG Generator
GABE_RNG_SEED_HI    = $AFE825 ; Hi Part of 16Bit RNG Generator
