...
SDMA_SRC_ADDY_M         = $AF0423 ; This needs to be within Vicky's Range ($00_0000 - $3F_0000)
SDMA_SRC_ADDY_H         = $AF0424

SDMA_DST_ADDY_L         = $AF0425 ; Destination Pointer within Vicky's video memory Range
SDMA_DST_ADDY_M         = $AF0426 ; ($00_0000 - $3F_0000)
