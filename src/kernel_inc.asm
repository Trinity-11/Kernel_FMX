...
F_RENAME         = $001108 ; rename a file
F_DIROPEN        = $00110C ; open a directory and seek the first directory entry
F_DIRNEXT        = $001110 ; seek to the next directory of an open directory
F_LOAD           = $001114 ; load a binary file into memory, supports multiple file formats
F_SAVE           = $001118 ; Save memory to a binary file
